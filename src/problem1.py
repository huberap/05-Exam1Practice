...
def problem1a(m, n):
    ...
    an = abs(n)
    am = abs(m)
    for k in range((an**2)-(am**2)+1):
        sum = sum + math.sin((k) + abs(m)**2)
    return sum
...
def run_test_problem1b():
    ...
    #test 1
    print('TEST 1')
    print('expected answer was',2 )
    print('calculated is', problem1b(2,2))

    #test 1
    print('TEST 2')
    print('expected answer was',3 )
    print('calculated is', problem1b(2,3))

    #test 1
    print('TEST 3')
    print('expected answer was',4 )
    print('calculated is', problem1b(2,4))

    #test 1
    print('TEST 4')
    print('expected answer was',4 )
    print('calculated is', problem1b(2,5))
